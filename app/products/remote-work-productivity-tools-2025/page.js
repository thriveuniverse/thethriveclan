...
const PRICE  = "$490";
/* 🔁  Replace the checkout URL below with your real Lemon Squeezy link  */
...
export default function RemoteWorkProdBundlePage() {
  return (
    <>
      {/* Lemon Squeezy modal script (move to layout.js if already global) */}
...
export const metadata = {
  title: "Remote‑Work Productivity Tools 2025 Bundle | The Thrive Clan",
  description: "150 keywords, templates & more to rank for remote‑work productivity searches.",
};
