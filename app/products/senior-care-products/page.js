// app/products/senior-care-products/page.js
import Script from "next/script";
import Link   from "next/link";

export const metadata = {
  title: "Senior‑Care Products Bundle | The Thrive Clan",
  description:
    "20 outlines, 150 keywords & more to rank, capture and convert searches for senior‑care and aging‑in‑place products.",
};

const PRICE = "$490";
const LS_URL = "https://yourstore.lemonsqueezy.com/checkout/buy/REPLACE_ME"; // ← replace

export default function SeniorCareBundlePage() {
  return (
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-16">
        <nav className="mb-10 text-sm text-gray-500">
          <Link href="/senior-care-and-products" className="hover:underline">
            ← Back to sector
          </Link>
        </nav>
        ...
        <header className="text-center mb-16">
          <h1 className="text-4xl font-semibold leading-tight mb-4">
            Senior‑Care Product Content Bundle — Capture Booming “Aging‑in‑Place” Demand
          </h1>
          <p className="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
            Rank, capture, and convert senior‑care buyers with proven outlines and keyword clusters.
          </p>
...
export const metadata = {
  title: "Senior‑Care Products Bundle | The Thrive Clan",
  description: "150 keywords, templates & more to rank for senior‑care and aging‑in‑place searches.",
};
