...
/* ————— page‑level <head> meta ————— */
export const metadata = {
  title: "Own the EV Accessory SERPs—Charging, Cables, Covers & More | The Thrive Clan",
  description:
    "20 outlines, 150 keywords & more to rank, capture and convert customer demand for electric‑vehicle accessories.",
};

const PRICE  = "$490";
const LS_URL = "https://yourstore.lemonsqueezy.com/checkout/buy/REPLACE_ME";

/* ——— component name should match the product, not ‘RemoteWork’ ——— */
export default function EVAccessoryBundlePage() {
  return (
    <>
      {/* Lemon Squeezy checkout script (include once globally if you prefer) */}
      <Script src="https://app.lemonsqueezy.com/js/lemon.js" strategy="afterInteractive" />

      <main className="mx-auto max-w-3xl px-4 py-16">
        {/* breadcrumb link back to the sector grid */}
        ...
        {/* ——— BODY SECTIONS (paste your long‑form copy here) ——— */}
