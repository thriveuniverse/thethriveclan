  ...
  return (
    <div className="min-h-screen bg-gray-50 py-16">
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-cyan-600 text-sm font-semibold uppercase tracking-wide mb-2">Pillar Two</div>
        <h1 className="text-4xl font-bold text-gray-900 mb-6">Resilience Intelligence</h1>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-3">Cascade Methodology — SSRN</h2>
          ...
          {/* Applied outputs */}
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div className="text-cyan-600 text-xs font-semibold uppercase tracking-widest mb-2">Applied Output</div>
            <h2 className="text-xl font-bold text-gray-900 mb-2">From Hormuz to Hunger</h2>
            <p className="text-gray-600 mb-4 leading-relaxed">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div className="text-cyan-600 text-xs font-semibold uppercase tracking-widest mb-2">Applied Output</div>
            <h2 className="text-xl font-bold text-gray-900 mb-2">The Fall of the UK</h2>
            <p className="text-gray-600 mb-4 leading-relaxed">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div className="text-cyan-600 text-xs font-semibold uppercase tracking-widest mb-2">Live Data</div>
            <h2 className="text-xl font-bold text-gray-900 mb-3">OilWatch Dashboards</h2>
            <p className="text-gray-600 mb-4 leading-relaxed">
        ...
        <div className="mt-12 p-6 bg-cyan-50 rounded-xl border border-cyan-100">
          <p className="text-gray-600 leading-relaxed">
            ...
            <Link href="/projects/decision-intelligence" className="text-cyan-600 hover:text-cyan-700 font-medium">
